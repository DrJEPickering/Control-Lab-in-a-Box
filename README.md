...
The table below outlines a schedule for using Control-Lab-in-a-Box (CLB) to support both theory and simulation teaching of control engineering. While a complete set of teaching notes for theory and simulation is not included, these can be provided upon request.
