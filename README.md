...
As used in the teaching curriculum, MathWorks Onramp self-paced online courses can be found at this [link]([https://github.com/DrJEPickering/Control-Lab-in-a-Box/blob/main/1.%203D_Printing](https://matlabacademy.mathworks.com/))
